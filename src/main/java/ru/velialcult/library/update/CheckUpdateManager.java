package ru.velialcult.library.update;
...
public class CheckUpdateManager {
    ...
    private static final String REPO = "VelialCult/CultLibrary";
    ...
    public void checkUpdates() {
        try {
            ...
            if (currentVersion.equals(latestVersion)) {
                plugin.getLogger().info("Используется последняя версия плагина: " + ChatColor.YELLOW + latestVersion);
            } else {
